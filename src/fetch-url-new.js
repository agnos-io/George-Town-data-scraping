...
const occupationMap={
    ...
    // 'hmin':'Internal Medicine',
    // 'hmmr':'MedicalResearch',
    // 'hnsu':'MedicalSurgicalNursing',
    // 'hmnp':'Nephrology',
    // "hmnr":'Neurology',
    // 'hdop':'OralPathology',
    // 'hdrd':'OralRadiology',
    // 'hdos':'OralSurgeryDental',
    // 'hmos':'OralSurgeryMedical',
    // 'hmpe':'Pediatrics',
    // 'hmpm':'PulmonaryMedicine',
    // 'hmca':'Cardiology',
    // 'hmcd':'CardiovascularDiseases',
     'hmal':'Allergy Medicine',
     'hmab':'Ambulatory Medicine',
     'hman':'Anesthesiology',
     'hmbari':'Bariatrics (Obesity)',
     'hncc':'Cardiac Care Nursing',
     'hmcy':'Cytopathology',
     'hmde':'Dermatology',
     'hmem':'Emergency Medicine',
     'hmen':'Endocrinology',
     'hden':'Endodontics',
     'hnfn':'Family Nursing',
     'hdfo':'Forensic Dentistry',
     'hmfo':'Forensic Medicine',
     'hnfor':'Forensic Nursing',
     'hmga':'Gastroenterology',
     'hdgp':'General Practice - Dentistry',
     'hmgp':'General Practice - Medicine',
     'hmgn':'Genetics',
     'hmgrnt':'Gerentology',
     'hmgr':'Geriatrics',
     'hngr':'Geriatrics - Nursing',
     'hdge':'Geriodontics',
     'hmgy':'Gynecology Only',
     '524000':'Insurance',
     'hnic':'Intensive Care Nursing',
     'hnma':'Maternity Nursing',
     'lmm':'Medical Malpractice Law',
     'hnmi':'Midwifery Nursing',
     'hnnc':'Neonatal Care Nursing',
     'hmnm':'Neonatal Medicine',
     'hmnu':'Nuclear Medicine',
     'hnna':'Nurse Anesthetist',
     'npract':'Nurse Practitioner',
     'hnad':'Nursing Admin/Health Sys Admin',
     'hncons':'Nursing Consultant',
     'hmob':'OB/GYN',
     'hnobgy':'OB/GYN Nursing',
     'hmoo':'Obstetrics Only',
     'hmom':'Occupational Medicine',
     'laoiga':'Oil and Gas Law',
     'hmon':'Oncology',
     'oncn':'Oncology - Nursing',
     'hnor':'Operating Room Nursing',
     'hmop':'Ophthalmology',
     'hdsx':'Oral/Maxillofacial Surgery',
     'hmor':'Orthopedics',
     'hnort':'Orthopedics Nursing',
     'osteo':'Osteopathy',
     'hmot':'Otorhinolaryngology',
     'hmpl':'Palliative Medicine',
     'hmpa':'Pathology',
     'hdpd':'Pediatric Dentistry',
     'hnpe':'Pediatrics - Nursing',
     '325400':'Pharmaceuticals & Medical Devices',
     'hmph':'Pharmacology',
     'hmpi':'Physiatry',
     'hmrm':'Physical/Rehabilitation Medicine',
     'hnpc':'Primary Care - Nursing',
     'hmpr':'Proctology',
     'hnps':'Psychiatric Nursing',
     'hmps':'Psychiatry',
     '923120':'Public Health',
     'hdph':'Public Health Dentistry',
     'hmraon':'Radiation Oncology',
     'hmra':'Radiology',
     'hmrd':'Radiology-Diagnostic',
     'hnre':'Rehabilitation Nursing',
     'hnmr':'Research Nursing',
     'hmrh':'Rheumatology',
     'hnsn':'School Nurse',
     '541700':'Scientific Research & Technology',
     'hmsd':'Sleep Disorders',
     'hmsy':'Surgery - Abdominal',
     'hmsc':'Surgery - Cardiovascular',
     'hmse':'Surgery - Colon & Rectal',
     'hmsf':'Surgery - Flight',
     'hmss':'Surgery - Gastrointestinal',
     'hmsg':'Surgery - General',
     'hmsh':'Surgery - Hand',
     'hmsk':'Surgery - Head & Neck',
     'hmsx':'Surgery - Maxillofacial',
     'hmsn':'Surgery - Neurological',
     'hmsb':'Surgery - Oncological',
     'hmsq':'Surgery - Ophthalmic',
     'hmso':'Surgery - Orthopedic',
     'hmsp':'Surgery - Pediatric',
     'hmsl':'Surgery - Plastic',
     'hmsi':'Surgery - Spine',
     'hmsr':'Surgery - Thoracic',
     'hmsu':'Surgery - Transplant',
     'hmst':'Surgery - Trauma',
     'hmsv':'Surgery - Vascular',
     'hmto':'Toxicology',
     'hmtm':'Transitional Medicine',
     'hntr':'Trauma Nursing',
     'hmur':'Urology',
     'hmvi':'Virology',
}
